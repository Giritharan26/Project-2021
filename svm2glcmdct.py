...
##		cells_per_block=(2, 2), transform_sqrt=True, block_norm="L2-Hys")
    ...
    GLCM4 = greycomatrix(gray, [0], [np.pi/4])       
    ...
    GLCM5 = greycomatrix(gray, [0], [np.pi/2])       
    ...
    img1 = gray.astype('float') #Convert uint8 to float type
